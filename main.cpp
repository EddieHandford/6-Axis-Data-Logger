...
File SlaveB;  // name of file on sd, yes i wasn't feeling very inventive
...
//mpu end =================================================================================
 ...
 //sd card ==============================================================================================
  ...
  if (SD.exists("SlaveB.txt")) { // if "file.txt" exists, fill will be deleted
    Serial.println("File exists.");
    if (SD.remove("SlaveB.txt") == true) {
...
//sd column headers
SlaveB = SD.open("SlaveB.txt", FILE_WRITE); // open "file.txt" to write data
 if (SlaveB) {
    
    SlaveB.print("Time is:");
    SlaveB.print("Acceleration X:");
    SlaveB.print("Y:"); 
    SlaveB.print("Z:");
    SlaveB.print ("Gyro X:");
    SlaveB.print("Gyro Y:");
...
SlaveB = SD.open("Slaveb.txt", FILE_WRITE); // open "file.txt" to write data
 if (SlaveB) {
    ...
    SlaveB.print(millistime); SlaveB.print(",");
    SlaveB.print(AcX); SlaveB.print(",");
    SlaveB.print(AcY); SlaveB.print(",");
    SlaveB.print(AcZ); SlaveB.print(",");
    SlaveB.print(GyX); SlaveB.print(",");
    SlaveB.print(GyY); SlaveB.print(",");
    SlaveB.print(GyZ); SlaveB.print(",");
    SlaveB.print(FSRval);
    SlaveB.println();
    SlaveB.close(); // close file 
