...
File Master;  // name of file on sd, yes i wasn't feeling very inventive
...
int FSRval = 0;  //FSR starting value
...
if (!SD.begin(chipSelect)) { // Initialize SD card
  ...
  if (SD.exists("Master.txt")) { // if "Master.txt" exists, file will be deleted
    Serial.println("File exists.");
   
    
    if (SD.remove("Master.txt") == true) {
...
//sd column headers
Master = SD.open("Master.txt", FILE_WRITE); // open "file.txt" to write data
 if (Master) {
    
    Master.print("Time is: , ");
    Master.print("Acceleration X: ,");
    Master.print("Y: ,"); 
    Master.print("Z: ,");
    Master.print ("Gyro X: ,");
    Master.print("Gyro Y: ,");
...
pinMode(9, OUTPUT);  // 10k resistor required as pull down to ground
digitalWrite ( 9 , HIGH) ;     // this will activate all the slaves
...
//sd card write ==================================================================================================================================================
Master = SD.open("Master.txt", FILE_WRITE); // open "Master.txt" to write data
 if (Master) {
    
    Master.print(millistime); Master.print(",");
    Master.print(AcX); Master.print(",");
    Master.print(AcY); Master.print(",");
    Master.print(AcZ); Master.print(",");
    Master.print(GyX); Master.print(",");
    Master.print(GyY); Master.print(",");
    Master.print(GyZ); Master.print(",");
    Master.print(FSRval);
    Master.println();
    Master.close(); // close file 
  } 
